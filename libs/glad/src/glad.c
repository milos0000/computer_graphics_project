/*
    ...
    OpenGL loader generated by glad 0.1.34 on Thu Oct 22 09:39:59 2020.
...
static int open_gl(void)
{
	...
	if (libGL != NULL) {
		void (*tmp)(void);
		tmp =
		    (void (*)(void))GetProcAddress(libGL, "wglGetProcAddress");
	...
	for (index = 0; index < (sizeof(NAMES) / sizeof(NAMES[0])); index++) {
		...
		if (libGL != NULL) {
			...
			gladGetProcAddressPtr =
			    (PFNGLXGETPROCADDRESSPROC_PRIVATE)dlsym(
...
static int get_exts(void)
{
	...
	if (max_loaded_major < 3) {
		...
		if (num_exts_i > 0) {
			exts_i = (char **)malloc((size_t)num_exts_i *
						 (sizeof *exts_i));
		}
...
static void load_GL_VERSION_1_0(GLADloadproc load)
{
	...
	glad_glTexParameteriv =
	    (PFNGLTEXPARAMETERIVPROC)load("glTexParameteriv");
...
static void load_GL_VERSION_1_1(GLADloadproc load)
{
	...
	glad_glCopyTexImage1D =
	    (PFNGLCOPYTEXIMAGE1DPROC)load("glCopyTexImage1D");
	glad_glCopyTexImage2D =
	    (PFNGLCOPYTEXIMAGE2DPROC)load("glCopyTexImage2D");
	...
	glad_glDeleteTextures =
	    (PFNGLDELETETEXTURESPROC)load("glDeleteTextures");
...
static void load_GL_VERSION_2_0(GLADloadproc load)
{
	...
	glad_glDisableVertexAttribArray =
	    (PFNGLDISABLEVERTEXATTRIBARRAYPROC)load(
	...
	glad_glVertexAttrib4d =
	    (PFNGLVERTEXATTRIB4DPROC)load("glVertexAttrib4d");
	...
	glad_glVertexAttrib4s =
	    (PFNGLVERTEXATTRIB4SPROC)load("glVertexAttrib4s");
...
static void load_GL_VERSION_3_0(GLADloadproc load)
{
	...
	glad_glBindBufferBase =
	    (PFNGLBINDBUFFERBASEPROC)load("glBindBufferBase");
	...
	glad_glClearBufferuiv =
	    (PFNGLCLEARBUFFERUIVPROC)load("glClearBufferuiv");
	glad_glClearBufferfv = (PFNGLCLEARBUFFERFVPROC)load("glClearBufferfv");
	glad_glClearBufferfi = (PFNGLCLEARBUFFERFIPROC)load("glClearBufferfi");
	glad_glGetStringi = (PFNGLGETSTRINGIPROC)load("glGetStringi");
	glad_glIsRenderbuffer =
	    (PFNGLISRENDERBUFFERPROC)load("glIsRenderbuffer");
	...
	glad_glGenerateMipmap =
	    (PFNGLGENERATEMIPMAPPROC)load("glGenerateMipmap");
	...
	glad_glMapBufferRange =
	    (PFNGLMAPBUFFERRANGEPROC)load("glMapBufferRange");
...
static void load_GL_VERSION_3_2(GLADloadproc load)
{
	...
	glad_glClientWaitSync =
	    (PFNGLCLIENTWAITSYNCPROC)load("glClientWaitSync");
...
static void load_GL_VERSION_3_3(GLADloadproc load)
{
	...
	glad_glDeleteSamplers =
	    (PFNGLDELETESAMPLERSPROC)load("glDeleteSamplers");
